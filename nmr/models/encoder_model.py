from nmr.networks import encoder, forward_fxns, embeddings
import torch
...
class EncoderModel(nn.Module):
    ...
    def __init__(self,
        ...
        if src_embed == 'mlp':
            ...
            src_embed_layer = embeddings.NNEmbedWithTypeFeature(source_size, d_model, padding_idx=src_pad_token)
